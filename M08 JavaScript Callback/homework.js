...
function mayuscula(nombre) {
   ...
   var nombreModificado=nombreSeparado.join("");
...
function map(array, cb) {
   ...
   // Tu código:
   var array1= array.map(element=>{return cb(element)})
   return array1
...
function filter(arrayOfStrings) {
   ...
   // Tu código:
   var arrayNew=arrayOfStrings.map(element=>{if(element[0]==="a"){return element}})
    var arrayNew1=[]
